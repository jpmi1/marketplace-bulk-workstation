...
The app has first-class `Intake`, `BTC Goal`, and `Agent Setup` screens. Use Intake for drag/drop photo imports, BTC Goal for manual progress tracking and CSV/XLSX exports, and Agent Setup to copy scoped Codex/Claude prompts.
